...
var builder = new ReopenUrlBuilder("https:\/\/www.megdexchange.com\/a\/display.php?r=2637827&treqn=935632873&runauction=1&crr=56ee4a87f9d71bd777ac,4nCdMlVRRHCK0gCdEkSZVVUKhmfK0BCIggCVA1WMllVL5nCdsUXR50VV5nCdU1VbZhQcBVXR50VV5nCd4nCdk3CdsESMxEUfc210e92505df6f55740&rtid=5e3dec8ee3c84");
var url = builder.build();

    var content = '<iframe width="300" height="250" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true"'
 + 'style="border: medium none; padding: 0; margin: 0; "'
 + 'sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5e3dec8ee3c84" frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5e3dec8ee3c84').removeAttribute('sandbox');
    }
