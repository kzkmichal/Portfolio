...
var builder = new ReopenUrlBuilder("https:\/\/www.megdexchange.com\/a\/display.php?r=2623679&treqn=73381211&runauction=1&crr=d4429d02071ee83f7200,YkMlsmbpxEMyUjMlknch1WayBlRyUCMwAjMtg2Y0FmbzZkMlMXZpZ3btZkMl02bj5iekhWZpZ3btZkMlYkMlE0MlMHc0RHaef3be796a5f89848c7c5&rtid=5e3dec8ee3e34");
var url = builder.build();
 ...
 + 'sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5e3dec8ee3e34" frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5e3dec8ee3e34').removeAttribute('sandbox');
    }
