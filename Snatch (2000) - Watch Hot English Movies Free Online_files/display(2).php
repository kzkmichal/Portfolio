...
var builder = new ReopenUrlBuilder("https:\/\/www.megdexchange.com\/a\/display.php?r=2634699&treqn=1078975034&runauction=1&crr=2d37c10845a534d26d87,QEMnkGbr5kMwcDMnsHcj92awJFRwciMyIDMvoWY2NGbxREMnE3ZrRXbvREMn8WbhxCemp2ZrRXbvREMnQEMnMUMnEnc2Znaed79c772da8092212396&rtid=5e3dec8ee39d5");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true"'
 + 'style="border: medium none; padding: 0; margin: 0;  max-width:100%; height:90px;"'
 + 'sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5e3dec8ee39d5" frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5e3dec8ee39d5').removeAttribute('sandbox');
    }
